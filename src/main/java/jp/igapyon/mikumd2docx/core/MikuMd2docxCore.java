...
public class MikuMd2docxCore {
    public static final String BASE_VERSION = "1.1.0";
    ...
    private static String resolveVersion() {
        Package runtimePackage = MikuMd2docxCore.class.getPackage();
        String implementationVersion = runtimePackage == null
                ? null
                : runtimePackage.getImplementationVersion();
        return implementationVersion == null || implementationVersion.trim().isEmpty()
                ? BASE_VERSION
